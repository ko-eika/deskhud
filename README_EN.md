...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/version-0.9.5-green.svg" alt="version">
...
DeskHud is an extensible **desktop pet engine**: switch **pet packs** (look + behavior), and toggle **HUD plugins** and their contributions. The UI is built with **egui + winit / egui_glow**, with multi-language support and local community pack loading (a store comes later). Current release: `0.9.5`, with instance-based HUD frame resolution and cross-plugin horizontal, vertical, and grid groups rendered as unified virtual slots.
...
git tag -a v0.9.5 -m "DeskHud 0.9.5"

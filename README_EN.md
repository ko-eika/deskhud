...
DeskHud is an extensible **desktop pet engine**: switch **pet packs** (look + behavior), and toggle **HUD plugins** and their contributions. The UI is built with **egui + winit / egui_glow**, with multi-language support and local community pack loading (a store comes later). Current release: `0.9.1`, with a modular settings UI, shared configuration components, and completed settings copy for pet and HUD configuration.
...
git tag -a v0.9.1 -m "DeskHud 0.9.1"

...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/version-0.6.23-green.svg" alt="version">
...
DeskHud is an extensible **desktop pet engine**: switch **pet packs** (look + behavior), and toggle **HUD plugins** and their contributions. The UI is built with **egui + winit / egui_glow**, with multi-language support and local community pack loading (a store comes later). Current release: `0.6.23`, with external recursive font discovery, Source Han Sans as the preferred default, organized fonts under the executable's `fonts/` directory, event-driven preference persistence, and smoother Big Eyes pointer behavior.
...
git tag -a v0.6.23 -m "DeskHud 0.6.23"

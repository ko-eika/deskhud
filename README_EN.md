...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/version-0.6.7-green.svg" alt="version">
...
DeskHud is an extensible **desktop pet engine**: switch **pet packs** (look + behavior), and toggle **HUD plugins** and their contributions. The UI is built with **egui + winit / egui_glow**, with multi-language support and local community pack loading (a store comes later). Current release line: `0.6.7`.
...
git tag -a v0.6.7 -m "DeskHud 0.6.7"

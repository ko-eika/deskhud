...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/version-0.9.9-green.svg" alt="version">
...
DeskHud is an extensible **desktop pet engine**: switch **pet packs** (look + behavior), and toggle **HUD plugins** and their contributions. The UI is built with **egui + winit / egui_glow**, with multi-language support and local community pack loading (a store comes later). Current release: `0.9.9`, with tree-based HUD layout editing, alignment guides, explicit apply/discard sessions, a cached built-in system monitor, and cross-plugin HUD groups.
...
git tag -a v0.9.9 -m "DeskHud 0.9.9"
